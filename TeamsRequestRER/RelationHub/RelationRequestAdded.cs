...
namespace Adidas.OIP
{
    public class RelationRequestAdded
    {
        ...
        public RelationRequestAdded(AzureFunctionSettings settings, GraphServiceClient graphServiceClient)
        {
        ...
        public async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequest req, ILogger log)
        {
            ...
            try
            {
                ...
                string QueueName = Environment.GetEnvironmentVariable("RelationQueue1");
