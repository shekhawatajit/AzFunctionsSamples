...
namespace SimplifiedDelegatedRER.ToeknHelper
{
    public class TokenManager
    {
        ...
        public TokenManager(string ClientID, string ClientSecret, HttpClient httpClient, string contextToken, string host)
        {
            _ClientID = ClientID;
        ...
        public ClientContext GetAppClientContextAsync(string siteUrl)
        {
            ...
            return authManager.GetACSAppOnlyContext(siteUrl, _ClientID, _ClientSecret);
        }
        ...
        public async Task<AccessTokenResponse> GetAccessTokenAsync(string siteUrl)
        {
            ...
            var clientId = GetFormattedPrincipal(_ClientID, null, tenantId);
        ...
        {
            var key = new SymmetricSecurityKey(Convert.FromBase64String(_ClientSecret));
            ...
            handler.ValidateToken(_contextToken, new TokenValidationParameters
            {
                ...
                ValidAudience = $"{_ClientID}/{_host}@{tenantId}",
                ValidateIssuer = true,
